...
/** Local command runners supported by the Windows adaptation. */
export type WindowsExecutionRunner = "powershell" | "wsl" | "docker";
export type ExecutionRunner = "auto" | WindowsExecutionRunner | "posix";

/** A runner health result shown in the desktop setup screen. */
export interface ExecutionRunnerStatus {
  kind: WindowsExecutionRunner;
  available: boolean;
  detail: string;
}
